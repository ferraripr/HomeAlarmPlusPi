...
namespace AlarmByZones.Alarm
{
    ...
    {
        /// <summary>
        /// Starts HTTP web server session
        /// </summary>
        public static void startHttp()
        {
            MFToolkit.Net.Web.HttpServer http = new MFToolkit.Net.Web.HttpServer(Alarm.ConfigDefault.Data.Http_port, new WebControlPanel());
            http.Start();
        }
    }
}
